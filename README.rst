...
More examples are provided in the `documentation on ReadThedoc <http://gdsctoolls.readthedocs.org/master/index.html>`. You can for example select a specific drug, or a set of drugs instead of the entire screening, or perform a sub selection on features. 
