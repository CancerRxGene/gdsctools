...
Here is a quick example on how to use **GDSCTools** to investigate the association between the IC50 of a given drug (across 52 breast cancer cell lines) and a genomic feature (e.g., TP53 mutation):
